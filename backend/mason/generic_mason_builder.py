...
class GenericMasonBuilder(dict):
    ...
    def _add_namespace(self, namespace, uri):
        """
    ...
    def _add_control(self, ctrl_name, href, **kwargs):
        """
    ...
    def _add_control_post(self, ctrl_name, title, href, schema):
        """
    ...
    def _add_control_put(self, ctrl_name, title, href, schema):
        """
    ...
    def _add_control_delete(self, ctrl_name, title, href):
        """
        Utility method for adding PUT type controls. The control is
